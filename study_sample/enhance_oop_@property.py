...
Traceback (most recent call last):
  File "enhance_oop_@property.py", line 29, in <module>
    print(s.set_score(9999))
  File "enhance_oop_@property.py", line 22, in set_score
    raise ValueError('score must between 0 ~ 100!')
...
r'''
Traceback (most recent call last):
  File "enhance_oop_@property.py", line 74, in <module>
    s.score = 9999
  File "enhance_oop_@property.py", line 63, in score
    raise ValueError('score must between 0 ~ 100!')
ValueError: score must between 0 ~ 100!
