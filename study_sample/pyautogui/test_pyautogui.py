...
pyautogui.moveRel(xOffset=0, yOffset=10, duration=0.0, tween=pyautogui.linear)
...
# 鼠标相对拖拽
pyautogui.dragRel(xOffset=100, yOffset=100, duration=0.0, button='left', mouseDownUp=False)
